...
class Model_EYDF(pynlo.model.Model):
...
class NLSE(pynlo.model.NLSE):
    ...
    def propagate(self, a_v, z, z_stop, dz, local_error, k5_v=None, cont=False):
        ...
        # ---- Propagate
        a_v, z, dz, k5_v, cont = Model_EYDF.propagate(
    ...
    def simulate(self, z_grid, local_error=1e-6, n_records=None, plot=None):
        return Model_EYDF.simulate(self, z_grid, local_error, n_records, plot)


class EYDF(pynlo.materials.SilicaFiber):
    def __init__(
        self,
        f_r=100e6,
        overlap_p=1.0,
